...
<?
$iblockId = getIdByCode($arResult["VARIABLES"]["ELEMENT_CODE"],$arParams["IBLOCK_ID"],"IBLOCK_ELEMENT");

$res = CIBlockElement::GetByID($iblockId);
if($ar_res = $res->GetNext())
{
	$currentPage["NAME"] = $ar_res['NAME'];
	$currentPage["PATH"] = $ar_res["LIST_PAGE_URL"].$ar_res["CODE"]."/";
}
// echo "<pre>";
//   echo print_r($ar_res);
//   echo "</pre>";
